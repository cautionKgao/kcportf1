      ...
      <div className="section-container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Graduate Data Engineer at BMW Group
          </p>
        </div>
        <div className="about-grid">
          <div className="about-text">
            <p>
              A Data Engineer currently working at BMW Group in the Quality Management department, where I use data-driven insights to enhance automotive quality standards.
            </p>
            <p>
              With technical expertise in SQL, Python, AWS cloud services, ETL pipeline development, and a range of BI and analytics tools. I hold a BSc Honours degree in Computer Science from the University of Limpopo with research focused on speech recognition.
            </p>
            <p>
